            ...
            <div className={styles.mobile_mri} id="service3">
                ...
                <div className="flex items-center container" id="targetElement">
                    <section data-aos="fade-left" data-aos-duration="1000">
                        ...
                        <p>Need dependable mobile MRI trailer or mobile CT trailer coverage? Our team delivers flexible MRI trailer rental and CT trailer rental options, plus 24/7 technical support. We service major OEM platforms including GE mobile MRI, Philips mobile MRI, and Siemens mobile MRI systems, with experienced technicians focused on uptime, image quality, and patient throughput.</p>
