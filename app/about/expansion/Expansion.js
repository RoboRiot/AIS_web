...
import expansionImage from "@/public/assets/images/exterior-1.jpg"
        ...
        <>
            <div className={`${styles.how_we_are} ${styles.how_expansion}`}>
                <div className="flex items-center container">
                    <figure data-aos="fade-left" data-aos-duration="1000"><Image src={expansionImage} alt="Mobile MRI trailer exterior with access stairs" /></figure>
