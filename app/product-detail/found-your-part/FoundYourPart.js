                ...
                <div className="container">
                    ...
                    <form className="flex w-100" onSubmit={handleSubmit} data-form-type="part_request" data-form-source="product_page">
                        <ul className="list-none">
                            ...
                            <li>
                                <label htmlFor="found-part-name">Name</label>
                                <input id="found-part-name" placeholder="Your name" type='text'
                                    value={name}
                            ...
                            <li>
                                <label htmlFor="found-part-email">Email</label>
                                <input id="found-part-email" placeholder="you@company.com" type="email"
                                        value={email}
                            ...
                            <li>
                                <label htmlFor="found-part-number">Part number</label>
                                <input id="found-part-number" placeholder="Part number" type="text"
                                        value={partNumber}
                        ...
                        <ul className="list-none">
                        <li>
                            <label htmlFor="found-part-message">System details <span>(optional)</span></label>
                            <textarea id="found-part-message" placeholder="Scanner model, urgency, quantity, or compatibility questions"
                                        value={message}
