...
export default function Navigation() {
    ...
    const handleSearch = (e) => {
        ...
        if (searchTerm.trim() !== '') {
            const path = `/search?q=${encodeURIComponent(searchTerm)}`; // Manually construct the path
            router.push(path);
        } else {
                ...
                <div className="container flex items-center">
                    ...
                    <div className={`ml-auto ${showMenu ? styles.active : ""} ${styles.navigation_list}`}>
                        <ul className="list-none flex items-center">
                            ...
                            <li><Link onClick={()=> setShowMenu(false)} className={pathname === '/about' ? styles.active : ''} href="/about">About Us</Link></li>
                        ...
                        <OutsideClickHandler
                            ...
                            >
                            <form onSubmit={handleSearch} className={`${pathname === '/search' ? styles.hidebtn : ""} ${styles.search_wrap} ${showSearch ? styles.active : ""}`}>
